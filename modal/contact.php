...
$php_main_email = "bojjikun0324@gmail.com";
...
if (filter_var($php_email, FILTER_VALIDATE_EMAIL)) {
		...
		. '<strong style="color:#1b1b1b;">Name:</strong>  ' . $php_name . '<br/>'
		. '<strong style="color:#1b1b1b;">Email:</strong>  ' . $php_email . '<br/>'
		. '<strong style="color:#1b1b1b;">Phone:</strong>  ' . $php_phone . '<br/>'
		. '<strong style="color:#1b1b1b;">Message:</strong>  ' . $php_message . '<br/><br/>'
